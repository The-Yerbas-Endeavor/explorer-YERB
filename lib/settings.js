...
exports.smartnode_health_page = {
  "enabled": true,
  "report_path": process.env.SMARTNODE_REPORT_PATH ||
    "/var/lib/yerbas-smartnode-check/yerbas-smartnodes.json",
...
exports.markets_page = {
  ...
  "exchanges": {
    "nestex": {
      "enabled": true,
      "trading_pairs": [ "YERB/USDT" ]
    }
  },

  // default_exchange
  "default_exchange": {
    "exchange_name": "nestex",
